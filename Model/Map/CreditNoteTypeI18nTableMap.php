...
class CreditNoteTypeI18nTableMap extends TableMap
{
    ...
    */
     ...
     */
    const COL_ID = 'credit_note_type_i18n.id';
    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'credit_note_type_i18n.locale';
    /**
     * the column name for the title field
     */
    const COL_TITLE = 'credit_note_type_i18n.title';
    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'credit_note_type_i18n.description';
    /**
     * the column name for the chapo field
     */
    const COL_CHAPO = 'credit_note_type_i18n.chapo';
    /**
     * the column name for the postscriptum field
     */
    const COL_POSTSCRIPTUM = 'credit_note_type_i18n.postscriptum';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CreditNoteTypeI18nTableMap::COL_ID, CreditNoteTypeI18nTableMap::COL_LOCALE, CreditNoteTypeI18nTableMap::COL_TITLE, CreditNoteTypeI18nTableMap::COL_DESCRIPTION, CreditNoteTypeI18nTableMap::COL_CHAPO, CreditNoteTypeI18nTableMap::COL_POSTSCRIPTUM, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CreditNoteTypeI18nTableMap::COL_ID => 0, CreditNoteTypeI18nTableMap::COL_LOCALE => 1, CreditNoteTypeI18nTableMap::COL_TITLE => 2, CreditNoteTypeI18nTableMap::COL_DESCRIPTION => 3, CreditNoteTypeI18nTableMap::COL_CHAPO => 4, CreditNoteTypeI18nTableMap::COL_POSTSCRIPTUM => 5, ),
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CreditNoteTypeI18nTableMap::COL_ID);
            $criteria->addSelectColumn(CreditNoteTypeI18nTableMap::COL_LOCALE);
            $criteria->addSelectColumn(CreditNoteTypeI18nTableMap::COL_TITLE);
            $criteria->addSelectColumn(CreditNoteTypeI18nTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(CreditNoteTypeI18nTableMap::COL_CHAPO);
            $criteria->addSelectColumn(CreditNoteTypeI18nTableMap::COL_POSTSCRIPTUM);
        } else {
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(CreditNoteTypeI18nTableMap::COL_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(CreditNoteTypeI18nTableMap::COL_LOCALE, $value[1]));
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                CreditNoteTypeI18nTableMap::removeInstanceFromPool($singleval);
            }
        }
