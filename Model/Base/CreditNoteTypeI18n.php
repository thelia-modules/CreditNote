...
use CreditNote\Model\Event\CreditNoteTypeI18nEvent;
...
/**
 * Base class that represents a row from the 'credit_note_type_i18n' table.
 *
 *
 *
 * @package    propel.generator.CreditNote.Model.Base
 */
abstract class CreditNoteTypeI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CreditNote\\Model\\Map\\CreditNoteTypeI18nTableMap';
    ...
    /**
     * Compares this with another <code>CreditNoteTypeI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>CreditNoteTypeI18n</code>, delegates to
     * <code>equals(CreditNoteTypeI18n)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CreditNoteTypeI18n The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CreditNoteTypeI18nTableMap::COL_ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[CreditNoteTypeI18nTableMap::COL_LOCALE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[CreditNoteTypeI18nTableMap::COL_TITLE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CreditNoteTypeI18nTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setChapo($v)
    {
        ...
        if ($this->chapo !== $v) {
            $this->chapo = $v;
            $this->modifiedColumns[CreditNoteTypeI18nTableMap::COL_CHAPO] = true;
        }
    ...
    public function setPostscriptum($v)
    {
        ...
        if ($this->postscriptum !== $v) {
            $this->postscriptum = $v;
            $this->modifiedColumns[CreditNoteTypeI18nTableMap::COL_POSTSCRIPTUM] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CreditNote\\Model\\CreditNoteTypeI18n'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_CHAPO)) {
            $modifiedColumns[':p' . $index++]  = '`chapo`';
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_POSTSCRIPTUM)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CreditNoteTypeI18n'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CreditNoteTypeI18n'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CreditNote\Model\CreditNoteTypeI18n
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CreditNote\Model\CreditNoteTypeI18n The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_ID)) {
            $criteria->add(CreditNoteTypeI18nTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_LOCALE)) {
            $criteria->add(CreditNoteTypeI18nTableMap::COL_LOCALE, $this->locale);
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_TITLE)) {
            $criteria->add(CreditNoteTypeI18nTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_DESCRIPTION)) {
            $criteria->add(CreditNoteTypeI18nTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_CHAPO)) {
            $criteria->add(CreditNoteTypeI18nTableMap::COL_CHAPO, $this->chapo);
        }
        if ($this->isColumnModified(CreditNoteTypeI18nTableMap::COL_POSTSCRIPTUM)) {
            $criteria->add(CreditNoteTypeI18nTableMap::COL_POSTSCRIPTUM, $this->postscriptum);
        }
    ...
    {
        $criteria = ChildCreditNoteTypeI18nQuery::create();
        $criteria->add(CreditNoteTypeI18nTableMap::COL_ID, $this->id);
        $criteria->add(CreditNoteTypeI18nTableMap::COL_LOCALE, $this->locale);
    ...
    public function hashCode()
    {
        ...
        //relation credit_note_type_i18n_fk_90b79e to table credit_note_type
        if ($this->aCreditNoteType && $hash = spl_object_hash($this->aCreditNoteType)) {
            $primaryKeyFKs[] = $hash;
        } else {
    ...
    {
        if ($this->aCreditNoteType === null && ($this->id != 0)) {
    ...
    {
        if (null !== $this->aCreditNoteType) {
            $this->aCreditNoteType->removeCreditNoteTypeI18n($this);
        }
        $this->id = null;
        $this->locale = null;
        $this->title = null;
    ...
    public function preSave(ConnectionInterface $con = null)
    {
        ...
        if (null !== $con
            ...
            $event = new CreditNoteTypeI18nEvent($this);

            $con->getEventDispatcher()
                ->dispatch(
                    CreditNoteTypeI18nEvent::PRE_SAVE,
                    $event
                );
    ...
    public function postSave(ConnectionInterface $con = null)
    {
        ...
        if (null !== $con
            ...
            $con->getEventDispatcher()
                ->dispatch(
                    CreditNoteTypeI18nEvent::POST_SAVE,
                    new CreditNoteTypeI18nEvent($this)
                );
        }
    }
    ...
    public function preInsert(ConnectionInterface $con = null)
    {
        ...
        if (null !== $con
            ...
            $con->getEventDispatcher()
                ->dispatch(
                    CreditNoteTypeI18nEvent::PRE_INSERT,
                    $event
                );
    ...
    public function postInsert(ConnectionInterface $con = null)
    {
        ...
        if (null !== $con
            ...
            $con->getEventDispatcher()
                ->dispatch(
                    CreditNoteTypeI18nEvent::POST_INSERT,
                    new CreditNoteTypeI18nEvent($this)
                );
        }
    }
    ...
    public function preUpdate(ConnectionInterface $con = null)
    {
        ...
        if (null !== $con
            ...
            $con->getEventDispatcher()
                ->dispatch(
                    CreditNoteTypeI18nEvent::PRE_UPDATE,
                    $event
                );
    ...
    public function postUpdate(ConnectionInterface $con = null)
    {
        ...
        if (null !== $con
            ...
            $con->getEventDispatcher()
                ->dispatch(
                    CreditNoteTypeI18nEvent::POST_UPDATE,
                    new CreditNoteTypeI18nEvent($this)
                );
        }
    }
    ...
    public function preDelete(ConnectionInterface $con = null)
    {
        ...
        if (null !== $con
            ...
            $con->getEventDispatcher()
                ->dispatch(
                    CreditNoteTypeI18nEvent::PRE_DELETE,
                    $event
                );
    ...
    public function postDelete(ConnectionInterface $con = null)
    {
        ...
        if (null !== $con
            ...
            $con->getEventDispatcher()
                ->dispatch(
                    CreditNoteTypeI18nEvent::POST_DELETE,
                    new CreditNoteTypeI18nEvent($this)
                );
        }
    }
